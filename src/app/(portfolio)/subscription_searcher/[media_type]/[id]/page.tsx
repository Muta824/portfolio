                        ...
                        {watchProviders.map((watchProvider: TMDBWatchProvider) => (
                            ...
                            >
                                <div className="p-6 text-center">
                                    <div className="w-16 h-16 mx-auto mb-4 flex items-center justify-center rounded-lg bg-gray-100 dark:bg-gray-800 overflow-hidden">
                                        {watchProvider.logo_path ? (
                                            <Image
                                                src={`https://image.tmdb.org/t/p/w92${watchProvider.logo_path}`}
